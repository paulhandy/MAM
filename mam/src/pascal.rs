...
pub fn estimate(input: isize) -> usize {
    let length = num::round_third(num::min_trits(input) as usize) as u8;
    ...
    length as usize + encoder_trit_count
}

pub fn encode(input: isize, out: &mut [Trit]) -> usize {
